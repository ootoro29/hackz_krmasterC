...
export default function TaihoGame({kind,scoreUserInfo,setScoreUserInfo,scoreInfo,setScoreInfo}:{kind:number,scoreUserInfo:UserScoreInfo|null,setScoreUserInfo:Dispatch<SetStateAction<UserScoreInfo|null>>,scoreInfo:Array<UserScoreInfo>,setScoreInfo:Dispatch<SetStateAction<Array<UserScoreInfo>>>}){
    const user = useAuth();
            ...
            checkCollision(balls: Ball[]) {
              for (let ball of balls) {
                ...
                if (this.health <= 0) {
                    ...
                    p5.fill(255,255,0);
                    p5.textSize(30);
                    p5.text(`GameCoins +${Math.floor((score/5)*1.5)}`, 80, 240);
                  }
                }
              }
            }
